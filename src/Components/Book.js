        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.row}>
            <div className={styles.item}>
              ...
              <span className={`${styles.socialMedia} ${isFavorited?styles.clickfav :styles.svgg}`} onClick={handleFavClick}>
                <svg 
                  className={isFavorited ?"clickfav": "svgg"}
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
            ...
            <div className={styles.item}>
              ...
              <span className={`${styles.socialMedia} ${styles.svggread}`} >
